...
export default class {
  constructor(platform) {
    ...
    // Configure HTTP agents with insecureHTTPParser for Node.js v22 compatibility
    // Meross servers may return non-strict HTTP responses that need lenient parsing
    this.httpAgent = new http.Agent({ insecureHTTPParser: true })
    this.httpsAgent = new https.Agent({ insecureHTTPParser: true })
